...
<table width="100%" height="100%" class="table table-bordered" style="margin-bottom:0">
    ...
    <tr>
        <td width="10%" class="rc-block vertical @php if(in_array($my_type,array('A','C'))) echo 'blinking' @endphp" style="vertical-align: middle;text-align:center;background-color:#c6c6c6"><span class="vertical" style="height:100%"><b>受け止める</b>傾向</span></td>
